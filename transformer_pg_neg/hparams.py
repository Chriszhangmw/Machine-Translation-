...
class Hparams:
    ...
    train_seg_path_x = os.path.join(output_dir, 'train_x.txt')
    train_seg_path_y = os.path.join(output_dir, 'train_y.txt')
    test_seg_path_x = os.path.join(output_dir, 'test_x.txt')
    test_seg_path_y = os.path.join(output_dir, 'test_y.txt')
    vocab_path = os.path.join(output_dir, 'vocab.txt')
    sif_embedding_path = os.path.join(output_dir, 'sif_emedding.txt')
    ...
    parser.add_argument("--test_seg_y_dir", default=test_seg_path_y, help="test_seg_y_dir")
    parser.add_argument("--vocab_path", default=vocab_path, help="Vocab path")
    parser.add_argument("--sif_embedding_path", default=sif_embedding_path, help="sif embedding")
